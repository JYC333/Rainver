...
| [plans/remote-host-provider-binding-plan.md](plans/remote-host-provider-binding-plan.md) | Server-managed model backend for remote-host runs (host×adapter provider binding, proxy reachability, daemon-side materialization) — in progress |
