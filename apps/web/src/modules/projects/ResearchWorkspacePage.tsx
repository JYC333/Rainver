...
import type { Note, Project, ResearchReadingList, ResearchWorkspace } from '../../types/api'
...
import { NotebookChatPanel } from './researchWorkspace/NotebookChatPanel'
import { ProjectNoteCard } from './researchWorkspace/NotebookView'
...
export default function ResearchWorkspacePage() {
  ...
  // The workspace call returns a light notes listing (id/title/version) for
  ...
  async function createNote() {
    ...
    try {
      const created = await notesApi.create({
        ...
        collection_id: workspace.notes_collection_id,
      })
