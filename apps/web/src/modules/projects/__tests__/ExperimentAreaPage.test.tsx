...
const PROJECT = {
  ...
  description: null, status: 'active' as const, current_focus: null, settings_json: null,
  template_key: 'blank', primary_mode: 'inquiry' as const, active_brief_version_id: null,
