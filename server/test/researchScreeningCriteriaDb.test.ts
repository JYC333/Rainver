...
beforeEach(async () => {
  ...
  await pool.query(`TRUNCATE project_source_bindings, project_research_screening_criteria, projects, source_channels, source_connections, source_provider_connectors, source_providers, source_connectors, space_memberships, users, spaces CASCADE`);
