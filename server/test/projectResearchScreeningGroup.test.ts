...
import { ProjectResearchScreeningCoordinator } from "../src/modules/projectResearch/pipeline/screeningCoordinator.js";
...
describe("projectResearchScreeningProgressDb", () => {
  ...
  const db = useTestDatabase(`${import.meta.filename}#projectResearchScreeningProgressDb`);
