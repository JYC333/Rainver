...
beforeEach(async () => {
  ...
  await pool.query(`TRUNCATE notes, note_collections, note_collection_items, note_links, space_objects, project_members, projects, space_memberships, users, spaces CASCADE`);
