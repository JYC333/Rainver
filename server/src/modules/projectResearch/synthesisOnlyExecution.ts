...
import { HttpError, objectValue, optionalString, withQueryableTransaction, type Queryable, type SpaceUserIdentity } from "../routeUtils/common.js";
...
import { PgAutomationRepository, type AutomationRow } from "../automations/repository.js";
import { WorkflowExecutionService } from "../automations/workflowExecutionService.js";
import { actionNodeHandlerRegistry, ActionNodeHandlerError, type ActionNodeContext, type ActionNodeResult } from "../automations/actionNodeRegistry.js";
...
import { resolveProjectResearchSynthesisPrompt, PROJECT_RESEARCH_SYNTHESIS_PROMPT_KEY } from "./promptRegistry.js";
import { RESEARCH_SYNTHESIS_OUTPUT_CONTRACT } from "./outputSchemas.js";
import { validateResearchArtifacts, type ResearchArtifactRecord } from "./artifactValidation.js";
import { ProjectResearchReportMaterializer } from "./reportMaterializer.js";
import { deriveStepStates, operationSteps, type ResearchOperationState } from "./operationProjection.js";
import { setResearchOperationState } from "./pipeline/operationProjectionWriter.js";
import { researchQueryText } from "./pipeline/synthesisCoordinator.js";
