...
export type PreparedConversationInputPart = PreparedConversationImage | PreparedConversationFile;
...
export class ConversationInputService {
   ...
   * only a manual retry asks for the immutable snapshot body.
   */
