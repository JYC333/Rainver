import { BlockList, connect, createServer, type Server, type Socket } from "node:net";
 ...
 *
 * **What is a real boundary here.** The private-range refusal, because the
 * proxy declines rather than the client neglecting to ask. Nothing dialled
...
/**
 * Every network a Run must never reach through this proxy: the instance's own
...
function buildBlockList(): BlockList {
  ...
  // Loopback, unspecified, unique-local, link-local, and the IPv6 metadata
  // address some providers serve.
