import type { FolderReadDaemonError, FolderReadKind as ProtocolFolderReadKind, HostServerFrameOf } from "@rainver/protocol";
import {
  buildTree,
  folderGitDiff,
  folderGitStatus,
 ...
 */
export function resolveFolderReadRequest(
  frame: Omit<HostServerFrameOf<"folder_read">, "type">,
