...
export const POLICY_ACTION_REGISTRY = [
  ...
  // means here and for the nine other actions that carry it.
  {
    ...
    current_enforcement_point: "not_implemented",
    description:
      "Create an Inquiry Thread in a Project the actor can write to. Reserved: the Project ACL on the Thread create route is what enforces this today.",
    lifecycle_status: "reserved",
    record_failure_mode: "best_effort",
  },
  {
  ...
  { action:"inquiry.thread.propose",resource_type:"inquiry_thread",default_risk_level:"medium",default_decision:"allow",audit_required:true,approval_capability:null,default_required_approver_role:null,current_enforcement_point:"server/src/modules/systemActions/systemActionDispatcher.ts",description:"Propose an Agent-drafted Inquiry Thread for human review.",lifecycle_status:"wired_direct",record_failure_mode:"fail_closed" },
  { action:"inquiry.iteration.propose",resource_type:"inquiry_thread",default_risk_level:"medium",default_decision:"allow",audit_required:true,approval_capability:null,default_required_approver_role:null,current_enforcement_point:"server/src/modules/systemActions/systemActionDispatcher.ts",description:"Propose an Agent-drafted Inquiry Thread conclusion (Iteration) for review.",lifecycle_status:"wired_direct",record_failure_mode:"fail_closed" },
